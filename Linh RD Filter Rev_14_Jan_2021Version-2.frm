...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frm1 
   ...
   ClientTop       =   465
   ClientWidth     =   4065
   OleObjectBlob   =   "Linh RD Filter Rev_14_Jan_2021Version-2.frx":0000
...
'================================================
    ...
    For i = 1 To demA
        Workbooks.OpenText fileToOpen(i), DataType:=xlDelimited, ConsecutiveDelimiter:=True, Space:=True
